        ...
        $result =
            [
                ...
                [
                    ...
                    '/api/pricing?storagetype=sas',
                    '/api/pricing?ram=96gb',
                    // checkbox
                    '/api/pricing?storagetype[]=ssd&storagetype[]=sas',
                    '/api/pricing?ram[]=4&ram[]=8&ram[]=96',
                    // range
                    '/api/pricing?storage-min=300&storage-max=500',
                    '/api/pricing?ram-min=32&ram-max=96',
                    // multiple
                    '/api/pricing?storagetype[]=ssd&location=AMS-01&ram-min=32&ram-max=96',
                    '/api/pricing?storagetype[]=ssd&location=AMS-01&ram-min=32&ram-max=96&storage-min=200&storage-max=300',
                ],
            ];
